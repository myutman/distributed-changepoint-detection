...
from myutman.fuse.fuse import MeanFuseForWindowAlgo
...
if __name__ == '__main__':
    ...
    for state in range(5):
        ...
        with open(f'centralized_vs_roundrobin_p={p_levels}_nnodes={n_nodess}_original_experiment1_mean_fuse_rule_algo_20k_iter_no_change_period_noise.json', 'w') as output_file:
