...
from myutman.generation import OriginalExperiment1UniformSampleGeneration
...
if __name__ == '__main__':
    ...
    for state in range(5):
        ...
        with open(f'centralized_vs_roundrobin_p={p_levels}_nnodes={n_nodess}_original_experiment1_algo_20k_iter.json', 'w') as output_file:
