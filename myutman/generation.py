...
def generate_change_terminal_order_sample(
    size: int = 100000,
    n_clients: int = 20,
    n_terminals: int = 20,
...
def generate_change_client_order_sample(
    size: int = 100000,
    n_clients: int = 20,
    n_terminals: int = 20,
    change_period: int = 1000,
...
def generate_change_reorder_client_terminals_sample(
    size: int = 100000,
    n_clients: int = 20,
    n_terminals: int = 20,
    change_period: int = 1000,
...
def generate_change_client_average_amount_sample(
    size: int = 100000,
    n_clients: int = 20,
    n_terminals: int = 20,
    change_period: int = 1000,
