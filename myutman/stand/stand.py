...
from myutman.fuse.fuse import Fuse
from myutman.node_distribution.node_distribution import NodeDistribution
from myutman.streaming_algo.streaming_algo import StreamingAlgo
from myutman.stand.stand_utils import calc_error
...
class Stand:
    def __init__(
        ...
        self.logger = logging.getLogger("Stand")
